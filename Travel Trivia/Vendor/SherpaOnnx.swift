...
///
/// Patched for this vendored copy: the bundled xcframework (willwade/
/// sherpa-onnx-spm v1.13.5, chosen because its "properly combined"
/// static library actually resolves onnxruntime's linker symbols —
/// see NarratorSpeechSynthesizer.swift) doesn't export
/// SherpaOnnxGetOnnxruntimeVersionStr in its c-api.h. Nothing in this
/// app calls this diagnostic-only helper.
